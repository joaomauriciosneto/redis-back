...
export class PrimeiraMigration1671237091219 implements MigrationInterface {
    name = 'PrimeiraMigration1671237091219'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "tasks"."note" ("id" character varying NOT NULL, "title" character varying NOT NULL, "description" character varying NOT NULL, "saveNote" boolean NOT NULL, "id_user" character varying NOT NULL, CONSTRAINT "PK_96d0c172a4fba276b1bbed43058" PRIMARY KEY ("id"))`);
